        ...
        <div style={{ fontFamily: "monospace", padding: "16px", maxWidth: "640px", margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
                ...
                <span style={{
                    ...
                    background: peakColor, color: "#fff",
            ...
            {action && (
                <div style={{
                    ...
                    background: "#f5f5f5", borderLeft: "4px solid #1565c0",
            ...
            <div style={{ marginBottom: "16px" }}>
                ...
                <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                    {pumps.map((pump) => (
                        <div key={pump.name} style={{
                            padding: "8px 14px", borderRadius: "8px",
                            background: pump.isOn ? "#1b5e20" : "#424242",
                            color: "#fff", minWidth: "100px", textAlign: "center",
                        }}>
            ...
            <div style={{ marginBottom: "16px" }}>
                ...
                <div style={{
                    ...
                    background: "#e0e0e0", borderRadius: "6px", overflow: "hidden",
                }}>
                    <div style={{
            ...
            <div style={{ display: "flex", gap: "16px", marginBottom: "16px", flexWrap: "wrap" }}>
                ...
                <Metric label="Net" value={`${((metrics?.flowIn ?? 0) - (metrics?.demand ?? 0)).toFixed(1)} gph`} />
            </div>

            {/* Cost */}
            <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
                <Metric label="Hour Cost" value={`$${metrics?.stepCost?.toFixed(4) ?? "—"}`} />
                <Metric label="Cumulative Cost" value={`$${metrics?.cumulativeCost?.toFixed(4) ?? "—"}`} accent />
            </div>
        </div>
    );
}
